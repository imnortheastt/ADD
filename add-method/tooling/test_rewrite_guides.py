...
class TestIdiomRetirement(unittest.TestCase):
    ...
    UBIQUITOUS_IDIOMS = {"on-ramp", "forward spine", "the spine", "state surface", "story surface", "trust layer", "safety net", "blind-spot", "blind spot", "touch-boundary", "touch boundary", "evidence auto-gate", "autonomy dial", "the dial", "lower the dial", "survivor layer", "the survivors", "survivor file", "intake altitude", "milestone altitude", "setup-altitude", "setup altitude", "foundation altitude", "every altitude"}

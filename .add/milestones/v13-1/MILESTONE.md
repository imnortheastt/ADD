...
- [ ] declared-path-confinement  depends-on: none — contract v2: a token resolving outside the project root counts 0, fail-closed (closes the §6-reviewed read leak)
...
- [ ] A declared token resolving outside the project root contributes 0 tests — no read occurs outside the root  (← declared-path-confinement)
